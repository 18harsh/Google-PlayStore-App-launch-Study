...
#    
    ...
    btn_save1=tk.Button(val,text='Save',state="disabled",fg='#ffffff',width=10,command=lambda:saveing(txt2,btn_save1,'user.csv',''))    
...
def add_app_data():
    ...
    btn_save=tk.Button(val,text='Save',state="disabled",width=10,bg="#102131",fg="white",command=lambda:saveing(txt,btn_save,'App-data.csv',datecombo))    
